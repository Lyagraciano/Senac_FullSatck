...
$sql2 = "SELECT SUM(quantidade) AS soma FROM produtos2";
...
$sql3 = "SELECT produtos2, TIMESTAMPIFF(DAY,NOW(),Validade) AS produtos2 ORDER BY prazo LIMIT 0,1;";
...
if ($linha3){
    ...
    <h1 class='card-subtitle mb-2 text-muted text-center'>$linha3[produto]</h1>
    <h2 class= 'card-subtitle mb-2 text-muted text-center'>$linha3[prazo]</h2>
    </div>
    </div>
    </div>
    ");
